...
length(Ci)
c123<-subset(df,df$Fecb<Ff & df$Fecb>Fi & df$Ciclo=="00")
nrow(c123)
```
...
Dias.improd.cerd.año<-((DTC)/ciclos)*(NPcp/medio.cerdas.presentes)*(360/as.numeric(Ff-Fi))
Dias.improd.cerd.año
Dias.improd.cerd.año<-((sum(Dur.Total)-sum(DL)-sum(DG))/ciclos)*(NPcp/medio.cerdas.presentes)*(360/as.numeric(Ff-Fi))
Dias.improd.cerd.año
length(Dur.Total)
ciclos
